 ...
 */
router.post("/respostas", authenticateToken, criarResposta);
 ...
 */
router.put("/respostas/:id", authenticateToken, atualizarResposta);
 ...
 */
router.delete("/respostas/:id", authenticateToken, deletarResposta);
