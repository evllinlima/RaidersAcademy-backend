...
import { atualizarDisciplina, criarDisciplina, deletarDisciplina, listarDisciplinas } from "../controllers/disciplinas.controller";
 ...
 */
router.post("/campus", autenticarAdmin, criarCampus);
 ...
 */
router.put("/campus/:id", autenticarAdmin, atualizarCampus);
 ...
 */
router.delete("/campus/:id", autenticarAdmin, deletarCampus);
 ...
 */
router.post("/curso", autenticarAdmin, criarCurso);
 ...
 */
router.put("/curso/:id", autenticarAdmin, atualizarCurso);
 ...
 */
router.delete("/curso/:id", autenticarAdmin, deletarCurso);
 ...
 */
router.post("/disciplina", autenticarAdmin, criarDisciplina);
 ...
 */
router.delete("/disciplina/:id", autenticarAdmin, deletarDisciplina);
 ...
 */
router.get("/campus", listarCampus);
 ...
 */
router.get("/disciplina", listarDisciplinas);
